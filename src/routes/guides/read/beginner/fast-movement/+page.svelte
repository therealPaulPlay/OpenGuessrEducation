...
<ol class="mb-4 list-decimal list-inside">
    ...
    <li>
        <b>Hold down </b><kbd class="kbd kbd-sm">Space</kbd>, or better yet, hold down <kbd class="kbd kbd-sm">Enter</kbd>, which can't lead to any accidental guesses.
    </li>
</ol>
...
<ol class="mb-4 list-decimal list-inside">
    ...
    <li>
        <b>Double-click</b> the <b>left mouse button</b> to teleport to that location. Ensure that the circular preview shows up underneath your mouse cursor,
        otherwise, the spot is not available.
    </li>
</ol>
