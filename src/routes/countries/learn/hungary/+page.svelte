...
<p class="mb-4">
	Hungary can be identified by its unique language and distinctive road infrastructure.
	The letters <b>ő</b> and <b>ű</b> are exclusive to Hungarian. Other useful indicators include holey utility poles, white
...
<ArticleEmbedPanorama
	src="https://www.google.com/maps/embed?pb=!4v1781199447671!6m8!1m7!1sOxDOGpDTvTVQjzm44McC9A!2m2!1d47.4961717894603!2d19.07075509027831!3f173.42827515832383!4f-9.963226969090783!5f0.7820865974627469"
/>
<p class="text-center mt-2">A typical street in Budapest.</p>
...
<ul class="mb-2 list-disc list-inside">
	...
	<li>Motorways are marked with blue signs and route numbers beginning with <b>M</b>.</li>
</ul>

<h2 class="text-2xl font-bold mt-8 mb-2">Details</h2>
<ul class="mb-2 list-disc list-inside">
	<li>Most of Hungary is rather flat, especially east of the Danube.</li>
	<li>Vehicles use EU-style license plates.</li>
	<li>Taxis commonly use yellow license plates.</li>
	<li>Agricultural fields cover large portions of the countryside.</li>
</ul>
...
/>
<p class="text-center mt-2">Typical countryside location with agricultural fields.</p>
